...
import RequestAndBidsInbox from '../components/RequestAndBidsInbox'
        ...
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <p className="text-sm text-blue-700">
              This is your personal dashboard where you can manage your service requests and receive
              real-time quotes.
            </p>
          </div>
          ...
          <RequestAndBidsInbox requestId={requestIdFromUrl} isAuthenticated={true} />
