...
export default function ContractorsListPage() {
  ...
  const handleContactClick = (contractorId: string) => {
    ...
    if (selected) {
      ...
      router.push(`/find-contractor/${slug}`)
    }
  }
      ...
      <div className="min-h-screen flex flex-col">
        <header className="sticky top-0 z-10 border-b bg-background">
          <div className="flex h-16 items-center px-4">
            <Link href="/confirmation" className="flex items-center gap-2 text-sm font-medium">
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center p-4">
          <div className="text-center space-y-4 max-w-md mx-auto">
            ...
            <Button onClick={() => router.push('/confirmation')} className="mt-4">
