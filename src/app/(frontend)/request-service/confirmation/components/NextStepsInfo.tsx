    ...
    <div className="space-y-4 dark:text-white ">
      ...
      <div className="bg-muted p-4 rounded-md">
        <ol className="list-decimal list-inside space-y-2">
          <li>Professionals in your area will receive a notification about your request.</li>
          <li>Within the next 24 hours, you should receive responses.</li>
          <li>We will send you updates via email and phone.</li>
          <li>You will be able to select the professional that best fits your needs.</li>
        </ol>
      </div>
    </div>
  )
